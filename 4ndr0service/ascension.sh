#!/usr/bin/env bash
# File: ascension.sh
# 4ndr0666OS: Arch Universal Ascension Protocol v8.5 (suite v1.5.0)
...
show_usage() {
    echo -e "${PSI_COLOR}4ndr0666OS | Ascension Protocol v8.5 (suite v${SUITE_VERSION:-1.5.0})${RESET_ASC}"
